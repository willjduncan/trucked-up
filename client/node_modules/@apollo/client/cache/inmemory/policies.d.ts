...
import { FragmentMap, StoreValue, StoreObject, Reference, isReference } from '@apollo/src/utilities';
import { IdGetter, MergeInfo, ReadMergeModifyContext } from "@apollo/src/cache/inmemory/types";
import { InMemoryCache } from '@apollo/src/cache/inmemory/inMemoryCache';
import { SafeReadonly, FieldSpecifier, ToReferenceFunction, ReadFieldFunction, ReadFieldOptions, CanReadFunction } from '@apollo/src/cache/core/types/common';
import { WriteContext } from '@apollo/src/cache/inmemory/writeToStore';
