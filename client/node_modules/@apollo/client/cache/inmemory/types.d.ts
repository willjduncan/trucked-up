...
import { Transaction } from '@apollo/src/cache/core/cache';
import { StoreObject, StoreValue, Reference } from '@apollo/src/utilities';
import { FieldValueGetter } from '@apollo/src/cache/inmemory/entityStore';
import { TypePolicies, PossibleTypesMap, KeyFieldsFunction, StorageType, FieldMergeFunction } from '@apollo/src/cache/inmemory/policies';
import { Modifier, Modifiers, ToReferenceFunction, CanReadFunction } from '@apollo/src/cache/core/types/common';
