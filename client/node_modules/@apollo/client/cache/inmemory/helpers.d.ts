...
import { NormalizedCache, InMemoryCacheConfig } from '@apollo/src/cache/inmemory/types';
import { KeyFieldsContext } from '@apollo/src/cache/inmemory/policies';
import { Reference, StoreValue, StoreObject, DeepMerger } from '@apollo/src/utilities';
