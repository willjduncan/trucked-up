...
import { ApolloLink, FetchResult, GraphQLRequest } from '@apollo/src/link/core';
import { ApolloCache, DataProxy } from '@apollo/src/cache';
import { Observable } from '@apollo/src/utilities';
import { UriFunction } from '@apollo/src/link/http';
import { ObservableQuery } from '@apollo/src/core/ObservableQuery';
import { ApolloQueryResult, DefaultContext, OperationVariables, Resolvers, RefetchQueriesOptions, RefetchQueriesResult, RefetchQueriesInclude } from '@apollo/src/core/types';
import { QueryOptions, WatchQueryOptions, MutationOptions, SubscriptionOptions } from '@apollo/src/core/watchQueryOptions';
import { FragmentMatcher } from '@apollo/src/core/LocalState';
...
import { mergeOptions } from "@apollo/src/utilities";
export { mergeOptions };
