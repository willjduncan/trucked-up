...
import { ApolloLink, FetchResult } from '@apollo/src/link/core';
import { Cache, ApolloCache } from '@apollo/src/cache';
import { Observable, Concast } from '@apollo/src/utilities';
import { QueryOptions, WatchQueryOptions, SubscriptionOptions, MutationOptions, ErrorPolicy, MutationFetchPolicy } from '@apollo/src/core/watchQueryOptions';
import { ObservableQuery } from '@apollo/src/core/ObservableQuery';
import { NetworkStatus } from '@apollo/src/core/networkStatus';
import { ApolloQueryResult, OperationVariables, MutationUpdaterFunction, OnQueryUpdated, InternalRefetchQueriesInclude, InternalRefetchQueriesOptions, InternalRefetchQueriesMap } from '@apollo/src/core/types';
import { LocalState } from '@apollo/src/core/LocalState';
import { QueryStoreValue } from '@apollo/src/core/QueryInfo';
...
declare type DefaultOptions = import("@apollo/src/core/ApolloClient").DefaultOptions;
